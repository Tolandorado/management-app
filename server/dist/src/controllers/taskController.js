...
const getTasks = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res.status(500).json({ message: `Error retirieving tasks/Ошибка при получении задач ${error.message}` });
    }
});
...
const getUserTasks = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res.status(500).json({ message: `Error retirieving user's tasks /Ошибка при получении задач пользователя ${error.message}` });
    }
});
...
const updateTaskStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        res.status(500).json({ message: `Error updating task/Ошибка обновления задачи :) ${error.message}` });
    }
});
