...
import { EllipsisVertical, EllipsisVerticalIcon, MessageSquare,  Plus } from 'lucide-react';
    ...
    return (
        ...
        >
            ...
            <div className='p-4 md:p-6'>
                ...
                <p className='text-sm text-gray-600 dark:text-neutral-500 mt-1'>
                    {task.description}
                </p>
